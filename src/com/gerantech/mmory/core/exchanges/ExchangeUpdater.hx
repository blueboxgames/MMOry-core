...
class ExchangeUpdater 
{
	...
	function addItems() : Void
	{
		...
		this.add(ExchangeType.C121_MAGIC, 0, 0, ResourceType.R4_CURRENCY_HARD + ":" + Exchanger.fixedRound(Exchanger.toHard(Exchanger.estimateBookOutcome(ExchangeType.BOOK_55_PIRATE,	arena, game.player.id))),	ExchangeType.BOOK_55_PIRATE	+ ":" + arena);
		this.add(ExchangeType.C122_MAGIC, 0, 0, ResourceType.R4_CURRENCY_HARD + ":" + Exchanger.fixedRound(Exchanger.toHard(Exchanger.estimateBookOutcome(ExchangeType.BOOK_56_JUNGLE,	arena, game.player.id))),	ExchangeType.BOOK_56_JUNGLE	+ ":" + arena);
		this.add(ExchangeType.C123_MAGIC, 0, 0, ResourceType.R4_CURRENCY_HARD + ":" + Exchanger.fixedRound(Exchanger.toHard(Exchanger.estimateBookOutcome(ExchangeType.BOOK_58_AMBER,	arena, game.player.id))),	ExchangeType.BOOK_58_AMBER	+ ":" + arena);
